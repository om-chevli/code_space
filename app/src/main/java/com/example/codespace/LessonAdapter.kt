...
class LessonAdapter(context: Context, dataSource: ArrayList<Lesson>) :
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val lessonListBinding =
            LessonTempateBinding.inflate(LayoutInflater.from(context), parent, false)
        val lessonView = lessonListBinding.root
        ...
        if (currentLesson != null) {
            ...
            lessonListBinding.textviewLessonLength.text =
                user.convertLessonLength(currentLesson.lengthInMin)
